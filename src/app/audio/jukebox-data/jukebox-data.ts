import { Tile } from "src/app/audio/types/tile";
...
export class JukeboxData { 
    ...
    private tiles: Array<Tile> = new Array<Tile>(); // all of the tiles
    ...
    getTile(index: number): Tile { return this.tiles[index]; }
    ...
    setTiles(tiles: Array<Tile>): void { this.tiles = tiles; }
}
